...
//         countinglet currentCount = parseInt(counter.innerHTML, 10)
...
// increment/decrement on button clicks
function minus(){
    let currentCount = parseInt(counter.innerHTML, 10)
    counter.textContent = currentCount - 1
}
...
// logs "like" for the currentCount, which update with # of likes
...
// pause which pauses counter, disables all buttons, label change to "resume"
// on second click, resumes count, enables all buttons, label changes back to "pause"
